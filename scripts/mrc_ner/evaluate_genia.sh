...
OUTPUT_DIR=/content/outputs/github_mrc/genia/large_lr4e-5_drop0.3_norm1.0_bsz32_hard_span_weight0.1_warmup0_maxlen128
# find best checkpoint on dev in ${OUTPUT_DIR}/train_log.txt
BEST_CKPT_DEV=${OUTPUT_DIR}/epoch=12.ckpt
